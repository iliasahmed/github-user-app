...
data class RepoItemApiResponse(
    ...
    @SerializedName("owner") val owner: ReposItemOwner?,
    @SerializedName("permissions") val permissions: ReposItemPermissions?,
    ...
    @SerializedName("template_repository") val templateRepository: Any?,
